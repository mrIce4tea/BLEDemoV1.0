...
public class ScanningActivity extends ListActivity {
    ...
    private static float SensorOneValue;
    ...
    private final BleWrapper myBleTherm = new BleWrapper();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        SettingsToSave settingsToSave = SettingsToSave.getSettings();
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        final Intent intent = new Intent(this, CoreClass.class);
        intent.putExtra(CoreClass.EXTRAS_DEVICE_NAME, device.getName());
        intent.putExtra(CoreClass.EXTRAS_DEVICE_ADDRESS, device.getAddress());
        intent.putExtra(CoreClass.EXTRAS_DEVICE_RSSI, mDevicesListAdapter.getRssi(position));

            BluetoothDevice mBluetoothDevice = null;
        if(mBluetoothDevice != null)
        {
            BluetoothGatt mBluetoothGatt = mBluetoothDevice.connectGatt(getApplicationContext(), false, mBleWrapper.mBleCallback);
    ...
    private void btDisabled() {
        Toast.makeText(this, "Bluetooth LE is required for this app. Please Turn On Bluetooth and relaunch the APP", Toast.LENGTH_LONG).show();
        finish();
    }
