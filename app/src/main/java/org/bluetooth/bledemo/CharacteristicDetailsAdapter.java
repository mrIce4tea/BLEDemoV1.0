...
public class CharacteristicDetailsAdapter extends BaseAdapter {
	...
	private static final String TAG = "CharDetailAdapter LOGS";
	...
	private boolean mIndicationEnabled = false;
	...
	public View getView(int position, View convertView, ViewGroup p) {
        ...
        if (convertView == null) {
			...
			fields.indicationBtn = (ToggleButton) convertView.findViewById(R.id.char_details_indication_switcher);
			...
			fields.indicationBtn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
			{
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
				{
					Log.d(TAG, "indication btn setonCheckedChangeListener");
					if (isChecked == mIndicationEnabled) return;
					mBleWrapper.setIndicationForCharacteristic(mCharacteristic, isChecked);
					mIndicationEnabled = isChecked;
				}
			});
