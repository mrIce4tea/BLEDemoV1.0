...
public class PeripheralActivity extends Activity  {
	...
	private TextView mDeviceTemperatureView;
	...
	BleWrapper.Units DegreesC;
	BleWrapper.Units DegreesF;



	public boolean isC()
	{
		Float value =  SensorOneValue;
		BleWrapper.Units isInputC = DegreesC;
		return true;

	}

	public String sensorOneValue(Float degreeUnits){


		degreeUnits = valueOf(((Float) this.SensorOneValue).toString());

		return String.valueOf(degreeUnits);
	...
	public void uiNewTempReading(final BluetoothGatt gatt,
								 final BluetoothDevice device,
								 final float temp)
	{
		runOnUiThread(new Runnable() {
			@Override
			public void run() {
				mDeviceTemperature = temp + "°";
				mDeviceTemperatureView.setText(mDeviceTemperature);
			}
		});
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mDeviceTemperature = intent.getStringExtra(EXTRAS_DEVICE_TEMP);
...
//		mDeviceTemperatureView = (TextView) findViewById(R.id.txtConSensorOneValue);
